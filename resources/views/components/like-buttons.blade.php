...
<div class="flex">
    <form action="/tweets/{{ $tweet->id }}/like" method="POST">
        ...
        {{ $tweet->isLikedBy(auth()->user()) ? 'text-blue-500' : 'text-gray-600' }}">
            <button type="submit" class="flex">
                <svg class="bi bi-hand-thumbs-up mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <form action="/tweets/{{ $tweet->id }}/like" method="POST">
        ...
        @method("DELETE")
        <div class="flex items-center mr-4
        {{ $tweet->isDislikedBy(auth()->user()) ? 'text-red-500' : 'text-gray-600' }}">
            <button type="submit" class="flex">
